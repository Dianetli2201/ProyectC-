...
namespace maintenance_calibration_system.Application.MaintenanceActivity.Queries.GetAllMaintenance
{
    ...
    {
        private readonly IMaintenanceActivityRepository<Maintenance> _maintenanceRepository; // Repositorio para manejar calibraciones

        // Constructor que inyecta el repositorio
        public GetAllMaintenanceQueryHandler(IMaintenanceActivityRepository<Maintenance> maintenanceRepository)
        {
            _maintenanceRepository = maintenanceRepository; // Asignar el repositorio de calibraciones
        }
