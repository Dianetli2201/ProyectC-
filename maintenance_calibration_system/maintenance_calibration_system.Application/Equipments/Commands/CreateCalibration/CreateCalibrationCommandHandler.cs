...
namespace maintenance_calibration_system.Application.Calibrations.Commands.CreateCalibration
{
    ...
    {
        private readonly ICalibrationRepository<Calibration> _calibrationRepository; // Cambiado para usar el repositorio de calibraciones
        private readonly IUnitOfWork _unitOfWork;

        public CreateCalibrationCommandHandler(
